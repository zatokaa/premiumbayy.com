...
<head>
    ...
    <title>Meme App - Dashboard</title>
    <!-- Favicon-->
...
<!--     <div class="search-bar">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php">Meme App - Dashboard</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div>
                    <img src="assets/images/ic_user.png" width="48" height="48" />
                </div>
            ...
            <div class="legal">
                <div class="copyright">
                    Copyright &copy; 2020 <a href="" target="_blank">Tomroid Technologies</a>
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.0
                </div>
